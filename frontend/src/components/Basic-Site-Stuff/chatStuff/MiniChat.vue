    ...
    <v-list dense style="margin-top: 65px; margin-bottom: 20px">
      ...
      >
        <div v-if="item.mostRecent" style="display: flex;">
          <v-list-item-avatar x-large tile color="red" v-if="!item.otherUser.profile.avatar">
          ...
          <div style="display: block;">
            <v-list-item-title v-if="item.otherUser.first_name">Teacher: {{item.otherUser.first_name}}
              {{item.otherUser.last_name}}
            </v-list-item-title>
            <v-list-item-title v-if="!item.otherUser.first_name">Student: {{item.otherUser.username}}
            </v-list-item-title>
            <v-list-item-content v-if="item.mostRecent">{{item.mostRecent.content}}
            </v-list-item-content>
          </div>
