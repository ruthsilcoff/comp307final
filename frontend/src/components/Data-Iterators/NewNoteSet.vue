...
<v-content style="padding: 20px;">
  ...
  <div class="noHoverDrop" style="width: 100%; border: 2px dashed black; margin-bottom: 20px;"
       id="dragDropPhotoBox" v-cloak @drop.prevent="addFile" @dragover.prevent="activateDragOver"
